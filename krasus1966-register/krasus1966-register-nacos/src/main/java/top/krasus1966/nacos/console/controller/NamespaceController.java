...
package top.krasus1966.nacos.console.controller;
...
import top.krasus1966.nacos.console.model.Namespace;
...
public class NamespaceController {
    ...
    public RestResult<List<Namespace>> getNamespaces(HttpServletRequest request,
        ...
        Namespace namespace0 = new Namespace("", "public", 200,
                persistService.configInfoCount(""), 0);
    ...
    public NamespaceAllInfo getNamespace(HttpServletRequest request, HttpServletResponse response,
        ...
        if (StringUtils.isBlank(namespaceId)) {
            ...
            return new NamespaceAllInfo(namespaceId, tenantInfo.getTenantName(), 200, configCount
                    , 2,
     ...
     */
    @PostMapping
    @Secured(resource = NacosAuthConfig.CONSOLE_RESOURCE_NAME_PREFIX + "namespaces", action =
            ActionTypes.WRITE)
    public Boolean createNamespace(HttpServletRequest request, HttpServletResponse response,
        ...
        persistService.insertTenantInfoAtomic("1", namespaceId, namespaceName, namespaceDesc,
                "nacos",
