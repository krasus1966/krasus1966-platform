...
package top.krasus1966.nacos.console.security.nacos;
...
import top.krasus1966.nacos.console.filter.JwtAuthenticationTokenFilter;
...
public class NacosAuthConfig extends WebSecurityConfigurerAdapter {
    ...
    public static final String UPDATE_PASSWORD_ENTRY_POINT = CONSOLE_RESOURCE_NAME_PREFIX + "user" +
            "/password";
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        if (StringUtils.isBlank(authConfigs.getNacosAuthSystemType())) {
            ...
            http.authorizeRequests().antMatchers("/instance/**", "actuator/**").permitAll();
        }
    }
