...
public class RoleController {
     ...
     */
    @GetMapping
    @Secured(resource = NacosAuthConfig.CONSOLE_RESOURCE_NAME_PREFIX + "roles", action =
            ActionTypes.READ)
     ...
     *
     * <p>This method is used for 2 functions: 1. create a role and bind it to GLOBAL_ADMIN. 2.
     * bind a role to an user.
     *
