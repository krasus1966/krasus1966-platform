...
package top.krasus1966.nacos.console.security.nacos.roles;
...
public class NacosRoleServiceImpl {
     ...
     *
     * <p>Note if the user has many roles, this method returns true if any one role of the user
     * has the desired
     * permission.
     *
    ...
    public void addRole(String role, String username) {
        ...
        if (GLOBAL_ADMIN_ROLE.equals(role)) {
            throw new IllegalArgumentException("role '" + GLOBAL_ADMIN_ROLE + "' is not permitted" +
                    " to create!");
        }
    ...
    public Page<PermissionInfo> getPermissionsFromDatabase(String role, int pageNo, int pageSize) {
        Page<PermissionInfo> pageInfo = permissionPersistService.getPermissions(role, pageNo,
                pageSize);
        if (pageInfo == null) {
            return new Page<>();
        }
