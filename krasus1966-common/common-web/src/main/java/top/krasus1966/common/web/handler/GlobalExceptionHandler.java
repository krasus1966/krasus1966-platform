...
import top.krasus1966.common.core.enums.ResultsEnum;
import top.krasus1966.common.core.exception.BizException;
import top.krasus1966.common.core.exception.CommonException;
...
public class GlobalExceptionHandler {
     ...
     * @description 自定义异常处理
     */
    @ExceptionHandler(value = {CommonException.class, BizException.class})
    ...
    public R<String> errorHandler(CaptchaException e) {
        log.error("CaptchaException:code={},msg={}", ResultsEnum.CAPTCHA_ERROR.getCode(), e.getMessage());
