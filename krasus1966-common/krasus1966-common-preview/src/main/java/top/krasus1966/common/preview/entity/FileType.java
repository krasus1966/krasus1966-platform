...
//    SIMTEXT("simTextFilePreviewImpl"),
    SIMTEXT("textFilePreviewService"),
    PDF("pdfFilePreviewServiceImpl"),
    ...
    private static final String[] SSIM_TEXT_TYPES = {"txt","html","htm","asp","jsp","xml","json","properties","md","gitignore","log","java","py","c","cpp","sql","sh","bat","m","bas","prg","cmd"};
    private static final String[] MEDIA_TYPES = {"mp3","wav","mp4","flv"};
    private static final String[] MEDIA_TYPES_CONVERT = {"avi","mov","wmv","mkv","3gp","rm"};
